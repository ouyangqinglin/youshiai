...
export const solutions: Solution[] = [
  {
    ...
    demoVideo: 'https://www.youtube.com/embed/demo-medicine',
    features: [
      {
        title: '用户场景',
        items: [
  ...
  //     },
  //   ],
  //   demoVideo: 'https://www.youtube.com/embed/demo-enterprise-llm',
  //   features: [
  //     {
  //       title: '核心能力',
  //       items: [
  ...
  //     }
  //   ],
  //   demoVideo: 'https://www.youtube.com/embed/demo-lightweight-ai',
  //   features: [
  //     {
  //       title: '核心能力',
  //       items: [
